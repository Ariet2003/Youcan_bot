...
class Question(Base):
    ...
    option_a: Mapped[str] = mapped_column(String(5))
    option_b: Mapped[str] = mapped_column(String(5))
    option_v: Mapped[str] = mapped_column(String(5))
    option_g: Mapped[str] = mapped_column(String(5))
